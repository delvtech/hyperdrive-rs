...
//!
//! This fixed point library is a heavily based on Solidity's FixedPointMath
...
pub mod prelude {
    pub use super::{
        fixed, fixed_i128, fixed_i256, fixed_point::FixedPoint, fixed_u128, fixed_u256, int256,
        sign::FixedPointSign, uint256, value::FixedPointValue,
    };
}
